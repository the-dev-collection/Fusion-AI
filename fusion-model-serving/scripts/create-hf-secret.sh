...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "2. Uncomment the hf-token-secret.yaml resource in:"
    echo "   fusion-model-serving/gitops/models/kustomization.yaml"
    echo ""
    echo "3. Deploy your gated model using the Llama example:"
