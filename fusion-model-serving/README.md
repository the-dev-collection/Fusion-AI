...
├── README.md
├── LLAMA_DEPLOYMENT_GUIDE.md            # Quick start guide for Llama models
├── gitops/
│   ├── models/
...
└── scripts/
    ...
    └── create-hf-secret.sh              # HuggingFace token secret creation script
```
...
### Creating the HuggingFace Token Secret

Use the provided helper script to create the secret:
...
#### Step 2: Deploy Using the Llama Example
